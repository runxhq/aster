...
const required = [
  ...
  "scripts/derive-approval-context.mjs",
  "scripts/derive-approval-context.test.mjs",
  "scripts/derive-approved-policies.mjs",
  "scripts/derive-approved-policies.test.mjs",
  ...
  ".github/workflows/approval-policy-derive.yml",
