...
subject_locator: nilstate/automaton#pr/14
...
A `issue-triage` run against `nilstate/automaton#pr/14` finished with `success`.

Summary: lane finished with success

Receipt reference: `rx_887b7e3b24eb4d098aed6862651d54ee`.
